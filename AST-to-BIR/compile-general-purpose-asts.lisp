...
(defmethod compile-ast ((ast cleavir-ast:return-from-ast) inserter)
  (push (let ((rv (compile-ast (cleavir-ast:form-ast ast) inserter)))
          ;; written in an odd way since we need to get the iblock from after
          ;; the form is done being compiled.
          (list (iblock inserter) (function inserter) rv))
